(function() {
  ...
  function setupProgram(a, b) {
    ...
    function finishClasses(a4) {
      ...
      a4.combinedConstructorFunction +=
        "return [\n" + a4.constructorsList.join(",\n  ") + "\n]";
      var f = new Function("$collectedClasses", a4.combinedConstructorFunction)(
        a4.collected
      );
    ...
    s.pending = map();
    s.constructorsList = [];
    s.combinedConstructorFunction =
      "function $reflectable(fn){fn.$reflectable=1;return fn};\n" +
      "var $desc;\n";
    for (var r = 0; r < t; r++) {
      var q = a[r];
      var p = q[0];
  ...
  var dart = [
      ...
      J,
      {
        ...
        be: function(a) {
          ...
          if (z != null) {
            ...
            if (y === x) return z.i;
            if (z.e === x)
              throw H.c(new P.cR("Return interceptor for " + H.a(y(a, z))));
          }
          w = a.constructor;
    ...
    [
      ...
      H,
      {
        ...
        c8: {
          ...
          sk: function(a, b) {
            throw H.c(
              new P.q("Cannot change the length of a fixed-length list")
            );
          },
          v: function(a, b) {
    ...
    [
      ...
      H,
      {
        ...
        dr: function(a, b) {
          ...
          if (!J.j(y).$isi)
            throw H.c(P.au("Arguments to main must be a List: " + H.a(y)));
          init.globalState = new H.h6(
            0,
            0,
            1,
            null,
          ...
          function(a, b) {
            ...
            switch (y.h(z, "command")) {
              case "start":
                ...
                q.v(0, 0);
                n.b5(0, o);
                init.globalState.f.a.F(
                  new H.aM(n, new H.eo(w, v, u, t, s, r), "worker-start")
                );
        ...
        bD: {
          ...
          a9: function(a) {
            ...
            try {
              ...
              if (z != null) $ = z.gdN();
              if (this.cx != null)
                for (; (t = this.cx), !t.gw(t); ) this.cx.bY().$0();
            }
            return y;
          },
          dA: function(a) {
          ...
          b5: function(a, b) {
            var z = this.b;
            if (z.am(a))
              throw H.c(P.aW("Registry: ports must be registered only once."));
            z.n(0, a, b);
          },
          aL: function() {
            var z = this.b;
            if (z.gk(z) - this.c.a > 0 || this.y || !this.x)
              init.globalState.z.n(0, this.a, this);
            else this.aQ();
          },
          aQ: [
            function() {
          ...
          c1: function() {
            ...
            if (z == null) {
              if (init.globalState.e != null)
                if (init.globalState.z.am(init.globalState.e.a))
              ...
              if (x) {
                ...
                x = new H.aa(
                  !0,
                  new P.d_(0, null, null, null, null, null, 0, [null, P.k])
                ).B(x);
                y.toString;
                self.postMessage(x);
              }
        ...
        cD: {
          ...
          al: function() {
            if (self.setTimeout != null) {
              if (this.b)
                throw H.c(new P.q("Timer in event loop cannot be canceled."));
              var z = this.c;
              if (z == null) return;
        ...
        aa: {
          ...
          B: [
            function(a) {
              ...
              if (!!z.$isd) this.c3(a);
              if (!!z.$iseZ)
                this.ah(a, "RawReceivePorts can't be transmitted:");
              ...
              return [
                "dart",
                init.classIdExtractor(a),
                this.ck(init.classFieldsExtractor(a))
              ];
            },
            "$1",
            "gci",
          ...
          ah: function(a, b) {
            throw H.c(
              new P.q(H.a(b == null ? "Can't transmit:" : b) + " " + H.a(a))
            );
          },
          c3: function(a) {
          ...
          cm: function(a) {
            ...
            if (!!a.constructor && a.constructor !== Object)
              this.ah(a, "Only plain JS Objects are supported:");
            z = Object.keys(a);
            y = [];
            C.c.sk(y, z.length);
        ...
        b9: {
          ...
          P: [
            function(a) {
              ...
              if (
                ...
                throw H.c(P.au("Bad serialized message: " + H.a(a)));
              switch (C.c.gdz(a)) {
                case "ref":
          ...
          dm: function(a) {
            ...
            for (z = J.F(y), v = J.F(x), u = 0; u < z.gk(y); ++u)
              w.n(0, z.h(y, u), this.P(v.h(x, u)));
            return w;
          },
          dn: function(a) {
            var z, y, x, w, v, u, t;
    ...
    [
      ...
      H,
      {
        ...
        r: function(a, b) {
          var z, y;
          if (typeof b !== "number" || Math.floor(b) !== b)
            return new P.a4(!0, b, "index", null);
          z = J.at(a);
          if (!(b < 0)) {
          ...
          if (a instanceof RangeError) {
            ...
            return z.$1(
              new P.a4(
                ...
                null,
                null,
                typeof y === "string" ? y.replace(/^RangeError:\s*/, "") : y
              )
            );
          }
        ...
        hV: [
          function(a, b, c, d, e, f, g) {
            ...
            throw H.c(
              P.aW("Unsupported number of arguments for wrapped closure")
            );
          },
          null,
          null,
        ...
        dX: function(a, b, c, d, e, f) {
          ...
          w = d
            ? Object.create(new H.f7().constructor.prototype)
            : Object.create(
                new H.bl(null, null, null, null).constructor.prototype
              );
        ...
        bi: function() {
          return (
            ...
            ((Math.random() * 0x100000000) >>> 0) * 4294967296
          );
        },
        bO: function(a) {
        ...
        af: function(a, b) {
          ...
          if (typeof a === "object" && a !== null && a.constructor === Array)
            return a[0].builtin$cls + H.dk(a, 1, b);
        ...
        C: function(a, b) {
          ...
          if ("func" in a)
            return b.builtin$cls === "bn" || b.builtin$cls === "b";
        ...
        hP: function() {
          ...
          z = H.ac(
            ...
            H.ac(
              C.x,
              H.ac(C.i, H.ac(C.i, H.ac(C.w, H.ac(C.t, H.ac(C.u(C.j), z)))))
            )
          );
        ...
        f1: {
          ...
          i: function(a) {
            ...
            z = this.b;
            if (z != null)
              for (y = z.length, x = "(", w = !1, v = 0; v < y; ++v, w = !0) {
                u = z[v];
                if (w) x += ", ";
                x += H.a(u);
              }
        ...
        f2: {
          ...
          G: function() {
            ...
            for (
              z = this.b, x = z.length, w = 0;
              w < z.length;
              z.length === x || (0, H.aQ)(z), ++w
            )
              y.push(z[w].G());
            this.c = y;
            return y;
    ...
    [
      ...
      H,
      {
        ...
        b1: {
          ...
          $isb1: 1,
          $isE: 1,
          "%": ";ArrayBufferView;bu|ch|cj|bv|ci|ck|X"
        },
      ...
      P,
      {
        ...
        fs: function() {
          ...
          if (self.MutationObserver != null && self.document != null) {
            ...
            z.a = null;
            new self.MutationObserver(H.ad(new P.fu(z), 1)).observe(y, {
              childList: true
            });
    ...
    [
      ...
      P,
      {
        ...
        V: function(a) {
          return H.hM(
            a,
            new H.U(0, null, null, null, null, null, 0, [null, null])
          );
        },
        et: function(a, b, c) {
          var z, y;
        ...
        h1: {
          ...
          af: function(a, b) {
            if (typeof b === "string" && b !== "__proto__")
              return this.ba(this.b, b);
            else if (typeof b === "number" && (b & 0x3ffffff) === b)
              return this.ba(this.c, b);
      ...
      P,
      {
        ...
        aV: {
          ...
          i: function(a) {
            ...
            z = this.b;
            y = P.e6(
              z ? H.y(this).getUTCFullYear() + 0 : H.y(this).getFullYear() + 0
            );
            x = P.av(
              z ? H.y(this).getUTCMonth() + 1 : H.y(this).getMonth() + 1
            );
            w = P.av(z ? H.y(this).getUTCDate() + 0 : H.y(this).getDate() + 0);
            v = P.av(
              z ? H.y(this).getUTCHours() + 0 : H.y(this).getHours() + 0
            );
            u = P.av(
              z ? H.y(this).getUTCMinutes() + 0 : H.y(this).getMinutes() + 0
            );
            t = P.av(
              z ? H.y(this).getUTCSeconds() + 0 : H.y(this).getSeconds() + 0
            );
            s = P.e7(
              z
                ? H.y(this).getUTCMilliseconds() + 0
                : H.y(this).getMilliseconds() + 0
            );
            if (z)
              return (
                y +
        ...
        T: {
          ...
          i: function(a) {
            ...
            v = new P.e9().$1(y % 1e6);
            return (
              "" + C.a.Z(y, 36e8) + ":" + H.a(x) + ":" + H.a(w) + "." + H.a(v)
            );
          }
        },
        e9: {
        ...
        ah: {
          ...
          i: function(a) {
            ...
            return (
              "Concurrent modification during iteration: " + H.a(P.aw(z)) + "."
            );
          }
        },
        cz: {
    ...
    [
      ...
      W,
      {
        ...
        e8: {
          ...
          gp: function(a) {
            ...
            return W.cY(
              W.a0(
                W.a0(
                  W.a0(W.a0(0, z & 0x1fffffff), y & 0x1fffffff),
                  x & 0x1fffffff
                ),
                w & 0x1fffffff
              )
        ...
        ay: {
          "^": "d;aO:data=,C:height=,E:width=",
          $isay: 1,
          "%": "ImageData"
        },
        iI: { "^": "P;", $isd: 1, $isv: 1, "%": "HTMLInputElement" },
        eR: {
          "^": "P;da:autoplay},R:error=",
        ...
        j5: {
          "^": "eR;e4:videoHeight=,e5:videoWidth=",
          "%": "HTMLVideoElement"
        },
        ...
        jh: {
          ...
          h: function(a, b) {
            if (b >>> 0 !== b || b >= a.length)
              throw H.c(P.aY(b, a, null, null, null));
            return a[b];
          },
          n: function(a, b, c) {
        ...
        aD: {
          ...
          h: [
            ...
            function(a, b) {
              if (typeof b !== "string" && typeof b !== "number")
                throw H.c(P.au("property is not a String or num"));
          ...
          bG: function(a, b) {
            ...
            y =
              b == null
                ? null
                : P.a7(new H.b0(b, P.i1(), [null, null]), !0, null);
      ...
      X,
      {
        ...
        f4: {
          ...
          dT: function(a, b, c) {
            var z, y, x, w;
            for (
              z = a.length, y = J.I(b), x = J.I(c), w = 0;
              w < a.length;
              a.length === z || (0, H.aQ)(a), ++w
            )
              if (a[w].de(0, y.aY(b), x.aY(c))) return !0;
            return !1;
          },
          e1: function() {
          ...
          cc: function(a, b) {
            ...
            if (z) return 0;
            for (
              y = b - 1, z = b + 1, x = a - 1, w = a + 1, v = 0, u = null;
              y <= z;
              ++y
            )
              for (t = x; t <= w; ++t) {
        ...
        cF: {
          ...
          bX: function(a, b, c) {
            ...
            for (
              ...
              r = z[1];
              if (r <= 128 || z[3] <= 128 || z[4] <= 128 || z[6] <= 128)
                return 0;
              n = z[2];
          ...
          ec: [
            function(a) {
              ...
              for (
                v = y.length, u = 0;
                u < y.length;
                y.length === v || (0, H.aQ)(y), ++u
              ) {
                t = y[u];
                t.dq(this.b);
                J.dC(w.h(0, "topcodes"), t.e2());
              }
              J.bU($.$get$bL(), "TopCodes").bG("_relayFrameData", [
                x,
                C.z.dt(w)
              ]);
            },
  ...
  J.bU = function(a, b) {
    if (typeof b === "number")
      if (
        a.constructor == Array ||
        typeof a == "string" ||
        H.dj(a, a[init.dispatchPropertyName])
      )
  ...
  J.dz = function(a, b, c) {
    if (typeof b === "number")
      if (
        (a.constructor == Array || H.dj(a, a[init.dispatchPropertyName])) &&
        !a.immutable$list &&
        b >>> 0 === b &&
        b < a.length
      )
  ...
  init.types = [
    ...
    { func: 1, v: true, args: [,], opt: [P.aH] },
    { func: 1, args: [, ,] },
    { func: 1, ret: P.H, args: [P.k] },
    { func: 1, args: [P.H, ,] },
    { func: 1, args: [, P.H] },
    { func: 1, args: [P.H] },
    { func: 1, args: [{ func: 1, v: true }] },
    { func: 1, args: [,], opt: [,] },
    { func: 1, v: true, args: [, P.aH] },
    { func: 1, args: [P.aJ, ,] },
    { func: 1, v: true, args: [P.cC] },
    { func: 1, v: true, args: [,] },
    { func: 1, ret: P.b, args: [,] },
    { func: 1, v: true, args: [P.H] }
  ];
